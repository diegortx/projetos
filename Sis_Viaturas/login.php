...
<html lang="pt-br">
  ...
  <div class="login-reg-panel">
		...
		<div class="register-info-box text-center">
			<h2>Controle de viaturas</h2><br>
			<p>Sistema criado para controle de viaturas no 14º GAC </p>
      <p>Qualquer duvida entre em contato com OF MOTO ramal: 5204</p>
...
{	
  ...
  $senha = addslashes($_POST['senha']);
	...
	if (!empty($usuario) && !empty($senha))
	{
		...
		$u->conectar("viaturas","127.0.0.1","root","root");	
		...
		if($u->msgErro == "")
		{
			...
			{	                 
        header("location: pages/dashboard/registrarViatura.php");
			}else
			{
