      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          <div class="mt-4 d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom" id="#dashBoards">
            <h1 class="h2">Relatorio Viatura</h1>
          ...
          <div class="container text-center">
            ...
            <p class="display-4 mb-4">Escolha o tipo do relatório</p>

            <div class="card-deck">
            <div class="card">
            <img class="card-img-top" src="../../img/logoRelatorio.jpg" alt="Imagem de capa do card">
            <div class="card-body">
            <h5 class="card-title">Viaturas fora</h5>
            <p class="card-text">Relaçao com todas as viaturas que estão fora da OM</p>

            <form method="POST" action="form/relatorioViaturasFora.php" target="_blank">
            ...
            <img class="card-img-top" src="../../img/logoRelatorio.jpg" alt="Imagem de capa do card">
            <div class="card-body">
            <h5 class="card-title">Todas as Viaturas</h5>
            <p class="card-text">Todas as viaturas que foram registradas até o momento</p>
            <form method="POST" action="form/relatorioTodasViaturas.php" target="_blank">
            ...
            <p class="card-text">Viaturas que já foram fechadas.</p>
            <form method="POST" action="form/relatorioViaturasFechadas.php" target="_blank">
