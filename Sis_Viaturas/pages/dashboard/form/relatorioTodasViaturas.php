...
$result_Registro = "SELECT v.motorista,v.chViatura,v.data_saida,v.data_retorno,v.ebViatura,v.obsViatura, a.nome_posto, u.nome FROM viaturasregistradas v INNER JOIN usuarios u ON v.abertoPor = u.cpf_mil INNER JOIN antiguidade a ON u.cod_posto_grad = a.cod_posto_grad ";
