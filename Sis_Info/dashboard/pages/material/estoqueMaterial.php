  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">  
    ...
    <a class="dropdown-item" href="estoqueMaterial.php">Estoque</a>
      ...
      <div class="text-center">
        <h2>Estoque de Material Permanente</h2>
...
<thead class="thead-success bg-success">
  ...
  <?php $result_Registro = "SELECT  * FROM material_Permanente ORDER BY id ";
   ...
   <tbody>   
       ...
       <td><?php echo $dado["num_ficha"] ?></td>
       <td><?php echo $dado["num_patrimonio"] ?></td>
       <td><?php echo $dado["nome_material"] ?></td>
       <td><?php echo $dado["local_material"] ?></td>
       <td><?php echo $dado["qtd_material"] ?></td>
       <td> <a href="../../../config/editarMatPermanente.php?id=<?php echo $idMaterialPermanente ?>" onclick="return confirm('Deseja mesmo editar essa maquina?');"><img src="../../../img/editIcon.jpg" alt=""></a> </td>
       <td> <a href="../../../config/excluirMatPermanente.php?id=<?php echo $idMaterialPermanente ?>" onclick="return confirm('Deseja mesmo excluir essa maquina?');"><img src="../../../img/remover.png" alt=""></a> </td>
   ...
   <?php  } ?>
      ...
      <div class="text-center">
        <h2>Estoque de Material Consumo</h2>
...
<thead class="thead-success bg-success">
   ...
   <tr>
        ...
        <th scope="col">Nome Material</th>
        <th scope="col">Nº Patr/ Cad Inicial</th>
  ...
  <?php $result_Registro = "SELECT  * FROM material_Consumo ORDER BY id ";
   ...
   <tbody>   
       ...
       <td><?php echo $dado["mat_Cad"] ?></td>
       <td><?php echo $dado["mat_Secao"] ?></td>
       <td><?php echo $dado["mat_Qnt"] ?></td>
       <td> <a href="../../../config/editarMatConsumo.php?id=<?php echo $idMaterialConsumo ?>" onclick="return confirm('Deseja mesmo editar essa maquina?');"><img src="../../../img/editIcon.jpg" alt=""></a> </td>
       <td> <a href="../../../config/excluirMatConsumo.php?id=<?php echo $idMaterialConsumo ?>" onclick="return confirm('Deseja mesmo excluir essa maquina?');"><img src="../../../img/remover.png" alt=""></a> </td>
