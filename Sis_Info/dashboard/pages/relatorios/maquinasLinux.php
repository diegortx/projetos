...
<div class="card text-center">
 ...
 <div class="card-header">
   ...
   <?php $result_Linux = "SELECT * FROM registromaquinas WHERE maq_tipo = 'LINUX' ";
        $maq_linux1 = mysqli_query($conn, $result_Linux);
        $maq_linux = mysqli_num_rows($maq_linux1);
        
        ?>

   <p class="h5">Total maquinas Linux registradas : <?php echo $maq_linux ?> </p>
...
<thead class="thead-success bg-success">
  ...
  <?php $result_Registro = "SELECT  id,maq_nome, maq_secao, maq_usuario, maq_tipo,maq_ip, maq_mac FROM registromaquinas WHERE maq_tipo = 'LINUX' ORDER BY id ";
