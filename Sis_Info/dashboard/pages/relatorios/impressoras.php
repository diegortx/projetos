...
<div class="card text-center">
 ...
 <div class="card-header">
   ...
   <?php $result_Impressora = "SELECT  * FROM registromaquinas WHERE maq_tipo = 'IMPRESSORA' ";
   ...
   <p class="h5">Total Impressores registradas : <?php echo $impressoras ?> </p>
...
<thead class="thead-success bg-success">
  ...
  <?php $result_Registro = "SELECT  id,maq_nome, maq_secao, maq_usuario, maq_tipo,maq_ip, maq_mac FROM registromaquinas WHERE maq_tipo = 'IMPRESSORA' ORDER BY id ";
