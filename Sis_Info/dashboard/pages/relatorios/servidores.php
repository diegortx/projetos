...
<div class="card text-center">
 ...
 <div class="card-header">
   ...
   <?php $result_Servidor = "SELECT * FROM registromaquinas WHERE maq_tipo = 'SERVIDOR' ";
        $servidores1 = mysqli_query($conn, $result_Servidor);        
        $servidores =  mysqli_num_rows($servidores1); 
        
        ?>

   <p class="h5">Total de Servidores registrados : <?php echo $servidores ?> </p>
...
<thead class="thead-success bg-success">
  ...
  <?php $result_Registro = "SELECT  id,maq_nome, maq_secao, maq_usuario, maq_tipo,maq_ip, maq_mac FROM registromaquinas WHERE maq_tipo = 'SERVIDOR' ORDER BY id ";
