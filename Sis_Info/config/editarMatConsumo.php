  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">  
    ...
    <a class="dropdown-item" href="../dashboard/pages/material/estoqueMaterial.php">Estoque</a>
      ...
      <div class="text-center">
        <h3>Editando o Material: <a class="text-success"><?php echo $mat_Nome?> </a></h3>
        <br><br>

                                <form method="POST" action="confEditarConsumo.php">
                        <div class="form-row">

                        <input type="hidden" name="idMaterialConsumo" value="<?php echo $idMaterialConsumo ?>">

                            <div class="form-group col-md-3 ml-5">
                            <label >Nome</label>
                            <input type="text" class="form-control" name="mat_Nome" value="<?php echo $mat_Nome ?>">
                            </div>

                            <div class="form-group col-md-3 ml-5 ">
                            <label >Nº Patr/Cad Inicial</label>
                            <input type="number" class="form-control" name="mat_Cad" value="<?php echo $mat_Cad ?>">
                            </div>   

                            <div class="form-group col-md-3 ml-5 ">
                            <label >Quantidade</label>
                            <input type="text" class="form-control" name="mat_Qnt" value="<?php echo $mat_Qnt ?>">
                            </div>                           
                            
                           
                            <div class="form-group col-md-4 ml-5">
                            <label >Local</label>
                            <input type="text" class="form-control" name="mat_Secao" placeholder="Ex: PABX, Sala Srv" value="<?php echo $mat_Secao ?>">
